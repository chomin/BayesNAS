...
PRIMITIVES = [
    ...
    'avg_pool_3x3',
    'skip_connect',
    'sep_conv_3x3',  # separableあるいはdepswise convolution.空間方向の畳込み。↓を参照
    'sep_conv_5x5',
    'dil_conv_3x3',  # ↓
    'dil_conv_5x5'
]
...
# また、operations.pyにnn.Moduleの子クラスとして実装されている。


NASNet = Genotype(
    normal=[
        ('sep_conv_5x5', 1),  # 各ノードの入力は２つ。右側の数字は矢印元のnodeのindex
        ('sep_conv_3x3', 0),
        ('sep_conv_5x5', 0),
        ('sep_conv_3x3', 0),
        ('avg_pool_3x3', 1),
    ...
    normal_concat=[2, 3, 4, 5, 6],  # 出力ノードへ繋がっているノードのindexs
    reduce=[
        ('sep_conv_5x5', 1),
        ('sep_conv_7x7', 0),
        ('max_pool_3x3', 1),
